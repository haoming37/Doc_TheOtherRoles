...
- [TheOtherRoles](#theotherroles)
	...
	- [カスタムロール](#カスタムロール)
		- [インポスター陣営](#インポスター陣営)
			...
			- [モーフィング(Morphling)](#モーフィングmorphling)
			- [カモフラジャー(Camouflager)](#カモフラジャーcamouflager)
			- [ヴァンパイア(Vampire)](#ヴァンパイアvampire)
			- [イレイザー(Eraser)](#イレイザーeraser)
			...
			- [トラッパー(Trapper)](#トラッパーtrapper)
			- [爆弾魔(Bomber)](#爆弾魔bomber)
			- [御船(Mifune)](#御船mifune)
			- [漢](#漢)
		...
		- [クルーメイト陣営](#クルーメイト陣営)
			...
			- [霊能力者(Seer)](#霊能力者seer)
			- [エンジニア(Engineer)](#エンジニアengineer)
			- [探偵(Detective)](#探偵detective)
			- [ライター(Lighter)](#ライターlighter)
			- [メディック(Medic)](#メディックmedic)
			- [市長(Mayor)](#市長mayor)
			- [ハッカー(Hacker)](#ハッカーhacker)
			- [シフター(Shifter)](#シフターshifter)
			- [タイムマスター(Time Masters)](#タイムマスターtime-masters)
			- [スワッパー(Swapper)](#スワッパーswapper)
			- [トラッカー(Tracker)](#トラッカーtracker)
			- [スニッチ(Snitch)](#スニッチsnitch)
			- [スパイ(Spy)](#スパイspy)
			- [セキュリティーガード(Security Guard)](#セキュリティーガードsecurity-guard)
			- [囮(Bait)](#囮bait)
			- [無能](#無能)
			- [占い師](#占い師)
		- [第3陣営](#第3陣営)
			- [ゲッサー(Guesser)](#ゲッサーguesser)
			- [ミニ(mini)](#ミニmini)
			- [ジェスター(Jester)](#ジェスターjester)
			- [恋人(Lovers)](#恋人lovers)
			- [ジャッカル(Jackal)](#ジャッカルjackal)
...
[TheOtherRoles+HaomingMod.2.8.19.zip](https://github.com/haoming37/Doc_TheOtherRoles/releases/download/2.8.19/TheOtherRoles+HaomingMod.2.8.19.zip)  
### 1. インストールフォルダを開く
